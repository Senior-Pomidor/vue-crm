	...
	<form class="card auth-card" @submit.prevent="submitHandler">
		<div class="card-content">
			...
			<div class="input-field">
				...
				v-model.trim="name" :class="{invalid: ($v.name.$dirty && !$v.password.required)}">
...
export default {
	...
	validations: {
		...
		name: {required},
		// для чекбокса сделаем свой валидатор с названием checked
		// функция прнимающая некоторый value (v)
		agree: {checked: v => v}
	},
	methods: {
		submitHandler() {
